...
> 🤝 **다른 PC/세션에서 작업을 이어받는다면** → [`CLAUDE.md`](CLAUDE.md)부터 읽으세요(환경 제약·PPT 안전 편집 방법론·슬라이드↔파일 매핑·버전 히스토리). 최신 보고서는 **V12**([`report/데이터지도_분석보고서_V12.pptx`](report/데이터지도_분석보고서_V12.pptx), 20장).
